        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t("hcm.dashboard.departmentDistribution")}
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t("hcm.dashboard.recentActivities")}
            </CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <table className="w-full">
              <thead className="border-b">
                <tr>
                  ...
                  <th className="text-left p-4 font-medium">{t("hcm.employees.columns.manager")}</th>
                  <th className="text-left p-4 font-medium">{t("hcm.employees.columns.location")}</th>
                  <th className="text-left p-4 font-medium">{t("hcm.employees.columns.hireDate")}</th>
                  <th className="text-left p-4 font-medium">{t("hcm.employees.columns.performance")}</th>
                  <th className="text-left p-4 font-medium">{t("hcm.employees.columns.status")}</th>
                  <th className="text-left p-4 font-medium">{t("hcm.employees.columns.actions")}</th>
                </tr>
              </thead>
              <tbody>
...
export default function HumanCapitalManagement() {
  ...
  return (
    <div className="w-full space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">{t("hcm.title")}</h1>
          <p className="text-muted-foreground">{t("hcm.description")}</p>
        </div>
        <div className="flex items-center gap-2">
          <Button variant="outline">
            <Bell className="mr-2 h-4 w-4" />
            {t("hcm.actions.notifications")}
          </Button>
          <Button variant="outline">
            <BarChart3 className="mr-2 h-4 w-4" />
            {t("hcm.actions.analytics")}
          </Button>
        </div>
      </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>{t("hcm.analytics.workforceAnalytics")}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>{t("hcm.analytics.predictiveInsights")}</p>
                </div>
              </CardContent>
            </Card>
          </div>
