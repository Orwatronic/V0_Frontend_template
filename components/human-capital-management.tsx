...
import { Users, UserPlus, Calendar, DollarSign, TrendingUp, AlertCircle, Search, Filter, Download, Upload, MoreHorizontal, Eye, Edit, Trash2, Mail, Phone, MapPin, Briefcase, GraduationCap, Award, Clock, Target, Star, CheckCircle, XCircle, FileText, BarChart3, PieChart, Activity, Zap, Settings, Bell, UserCheck, UserX, Building, Globe } from 'lucide-react'
...
const getActivityIcon = (type: string) => {
  switch (type) {
    case 'hire': return <UserPlus className="h-4 w-4 text-green-500" />
    case 'promotion': return <TrendingUp className="h-4 w-4 text-blue-500" />
...
export default function HumanCapitalManagement() {
  ...
  return (
    <div className="w-full space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Human Capital Management</h1>
          <p className="text-muted-foreground">
            Comprehensive employee lifecycle management and workforce analytics
          </p>
        </div>
        <div className="flex items-center gap-2">
          <Button variant="outline">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>AI-powered workforce predictions</p>
                </div>
              </CardContent>
            </Card>
          </div>
