...
export default function CrmDashboard() {
  ...
  async function fetchFunnel(): Promise<FunnelStage[]> {
    ...
    return [
      { id: 'leads', labelKey: 'crm.dashboard.funnel.stages.leads', value: leads, percent: Math.round((leads / total) * 100) },
      { id: 'qualified', labelKey: 'crm.dashboard.funnel.stages.qualified', value: qualified, percent: Math.round((qualified / total) * 100) },
      { id: 'proposals', labelKey: 'crm.dashboard.funnel.stages.proposals', value: proposals, percent: Math.round((proposals / total) * 100) },
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Badge variant="secondary" className="text-xs">{t('crm.dashboard.funnel.badge')}</Badge>
            </CardTitle>
          </CardHeader>
          <CardContent>
